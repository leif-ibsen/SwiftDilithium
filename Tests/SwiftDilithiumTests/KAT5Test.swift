...
final class KAT5Test: XCTestCase {

    // Test vectors from https://github.com/post-quantum-cryptography/KAT

    override func setUpWithError() throws {
        let url = Bundle.module.url(forResource: "kat5", withExtension: "rsp")!
    ...
    func test() throws {
        for t in katTests {
            let (pk, sk) = Dilithium.D5.KeyGen(t.xi)
            XCTAssertEqual(pk, t.pk)
            XCTAssertEqual(sk, t.sk)
            let sig = Dilithium.D5.Sign(sk, t.msg)
